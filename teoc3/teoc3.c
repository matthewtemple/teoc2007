/*  teoc3.c - the evolution of culture - created 2008 by inhaesio zha        */
/*  gcc -ansi -O3 -lcurses -o teoc3 teoc3.c                                  */
...
#define WORLD_WIDTH 209
#define WORLD_HEIGHT 71

#define ORGANISM_COUNT (WORLD_WIDTH * WORLD_HEIGHT) / 2
